...
if (isset($_GET['readID'])) {
    ...
    if ($mesajSil->rowCount()) {
        echo '<script>alert("Mesaj silinmiştir")</script><meta http-equiv="refresh" content="0; url=digerMesajlar.php">';
    } else {
        echo '<script>alert("Mesaj Silinirken Hata Oluştu")</script><meta http-equiv="refresh" content="0; url=digerMesajlar.php">';
    }
}
?>
<div class="row">
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><a href="digerMesajlar.php?readID=<?php echo $mesajlarList['id']; ?>"><button class="btn btn-warning"><?php echo $mesajlarList['durum']; ?></button></a></td>
                        <td><a href="digerMesajlar.php?deleteID=<?php echo $mesajlarList['id']; ?>"><button class="btn btn-danger">Sil</button></a></td>
                    </tr>
            <?php
                }
            }
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        if (isset($_POST['durumUP'])) {
                            ...
                            if ($durumG->rowCount()) {
                                echo '<script>alert("Mesaj durumu Okundu olarak güncellendi")</script><meta http-equiv="refresh" content="0; url=digerMesajlar.php">';
                            } else {
                                echo '<script>alert("Hata oluştu")</script><meta http-equiv="refresh" content="0; url=digerMesajlar.php">';
                            }
                        }
                        ?>
                    </div>
